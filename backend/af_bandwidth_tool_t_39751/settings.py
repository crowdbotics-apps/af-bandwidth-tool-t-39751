"""
Django settings for af_bandwidth_tool_t_39751 project.
...
ROOT_URLCONF = 'af_bandwidth_tool_t_39751.urls'
...
WSGI_APPLICATION = 'af_bandwidth_tool_t_39751.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "af_bandwidth_tool_t_39751 API",
    "DESCRIPTION": "API documentation for af_bandwidth_tool_t_39751 App",
    "VERSION": "v1",
}
